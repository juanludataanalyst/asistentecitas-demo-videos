...
export const WhatsAppChat = ({ logo }: WhatsAppChatProps) => {
  // logo is optional and can be used for future enhancements
  void logo;
  ...
  const inputDelay = 10; // Bar appears early with header
            ...
            >
              ...
              >
                <div style={{
                  ...
                  General, confirmado el pedido para el 23 de noviembre a las 11:30 AM
                </div>
            ...
            >
              ...
              >
                <div style={{
                  ...
                  <strong>Starter Pack: Cake + Bakery</strong>
                </div>
                <div style={{
                  fontSize: 14,
                  color: "#E9EDEF",
