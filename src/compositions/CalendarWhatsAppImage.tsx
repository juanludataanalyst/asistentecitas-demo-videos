...
export const CalendarWhatsAppImage = () => {
  return (
    <AbsoluteFill
      style={{
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            La IA habla con tus clientes y guarda tus citas en el calendario.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          >
            <img
              src={new URL('../../calendar_screenshot.PNG', import.meta.url).href}
              alt="Calendario de Asistentecitas"
              style={{
                width: "100%",
                height: "100%",
                objectFit: "contain",
        ...
        {/* Phone frame - WhatsApp (right side of calendar) */}
        <div
          style={{
            position: "absolute",
            bottom: "30px",
